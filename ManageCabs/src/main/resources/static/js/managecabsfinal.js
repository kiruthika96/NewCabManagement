  ...
  if(xhrCabDetails.readyState == 4 && xhrCabDetails.status == 200)
            {
             ...
             rowCounter = 0;
       		 ...
       		 sessionStorage.setItem("cabCount",arr.length);
...
window.sessionStorage;
    ...
    var pagerName;
    var cabCount = sessionStorage.getItem("cabCount");
    
    var cabPager = new cabPager('cab-info', PerPagesize);
    cabPager.init();
    cabPager.showPageNav('cabPager', 'cabPageNavPosition');
    ...
    var showingPage = document.getElementById('showCabPage'); 
    function cabPager(tableName, itemsPerPage) {
      ...
      this.showCabPage = function (pageNumber) {
      ...
      this.prev = function () {
        if (this.currentPage > 1) {
          ...
          this.showCabPage(this.currentPage - 1);
        }
      }
      ...
      this.next = function () {
        if (this.currentPage < this.pages) {
          ...
          this.showCabPage(this.currentPage + 1);  //it is used to print  imediate next records.
      ...
      this.createPager = function (startEle, EndEle) {
        ...
        if (EndEle <= this.pages && startEle > 0) {
         ...
         var element = document.getElementById("cabPageNavPosition");
          for (var page = startEle; page <= EndEle; page++)


            pagerHtml += ' <span id="pg' + page + '" class="pg-normal" onclick="' + pagerName + '.showCabPage(' + page + ');">' + page + ' </span> &nbsp; ';;
